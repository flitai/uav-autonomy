...
| 当前执行结果 | 鼠标拖动调整：普通 g5-coverage-build-20260922-134929-900、中文 g5-coverage-build-20260922-134901-892；构建和真实浏览器专项 g5-coverage-mouse-check-20260922-134949-352 passed；父版本全量覆盖验收保留，正式前端指针保持 |
...
2026-09-22 侦察覆盖补充及鼠标调整已完成：两种覆盖独立开关，后台继续累计、刷新恢复；普通左键拖动缩放、右键拖动平移／环绕，左键点击仍选择。旧预览 g5-coverage-session-20260922-121323-878 已正常退出，当前预览 g5-coverage-session-20260922-135252-148，1 倍时间、三实体位移和累计运行身份通过。鼠标专项及正常退出见 [报告第 6 节](g5-coverage-display-validation.md#6-左右键拖动调整2026-09-22)；下一卡仍为 T08。

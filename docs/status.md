...
2026-09-22 侦察覆盖及当前导航方式已完成：左键拖动平移、右键拖动环绕、滚轮缩放，左键点击仍选择；跟随时平移不解除跟随。旧预览 g5-coverage-session-20260922-135252-148 已正常退出，新预览 g5-coverage-session-20260922-141126-456 保留运行，1 倍时间／三实体移动及累计运行身份通过。见 [报告第 7 节](g5-coverage-display-validation.md#7-左键平移与右键环绕2026-09-22)，下一卡仍为 T08。

...
| 本轮变更 | T03 根级 CMake、Windows 构建／验收入口、C++ 探针及报告；最终批次为 `g2-t03-build-20260918-143841-186`／`g2-t03-test-20260918-143927-259`，按持续授权归档，过程见 WL-20260918-007。T02 已随 `a13f698`、`1af7a91` 推送 |

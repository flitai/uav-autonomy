function(boost_modular_build)
	...
	if(VCPKG_PLATFORM_TOOLSET STREQUAL "v143")
	    set(BOOST_LIB_RELEASE_SUFFIX -vc143-mt.lib)
	    set(BOOST_LIB_DEBUG_SUFFIX -vc143-mt-gd.lib)
    ...
    if(VCPKG_CONCURRENCY)
        set(NUMBER_OF_PROCESSORS ${VCPKG_CONCURRENCY})
    endif()
    ...
    find_program(UXAS_CL cl.exe REQUIRED)
